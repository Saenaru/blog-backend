...
Для запуска блога у вас уже должен быть установлен Python 3. Pillow 8.3.2 может не поддерживать Python 3.12. рекомендую использовать для корректной работы Python 3.10.
